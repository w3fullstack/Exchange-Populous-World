...
{  
    ...
    { 
        ...
        $not_writeable = array();
        $writeable     = array();
        $writeable_success = array();
        $writeable_error   = array();
    ...
    public function extensionCheck($extensions=null) 
    {
        ...
        if (version_compare(phpversion(), '5.6.1', '<')) {
            ...
            $fail[] = 'You need<strong> PHP 5.6.1</strong> (or greater;<strong>Current Version:'.phpversion().')</strong>';
            //set error status for php version
            $fail_status[] = '<span class="label label-danger">Error</span>';
        } else {
            //set success message for php version
            $pass[] ='You have<strong> PHP 5.6.1</strong> (or greater; <strong>Current Version:'.phpversion().')</strong>';
        ...
        foreach($extensions as $extension) {
            if (!extension_loaded($extension)) {
                ...
                $fail_status[] = '<span class="label label-danger missed-error">Error</span>';
            } else {   
