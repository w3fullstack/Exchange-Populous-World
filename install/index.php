    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon.png" alt="logo"> TradeBox Trading System Installer</h1>
                    </div>
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="index.php?step2" class="cbtn pull-right missed-disable">Next</a>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            var finderror = $("span").hasClass("missed-error");
            if (finderror) {
                $(".missed-disable").addClass("dbtn");
                $(".missed-disable").attr('href', "#");
            }
